...
var Client = exports.Client = function (opts) {
  ...
  // BW TODO: Check if this is absolutely necessary to be distinct or
  // just an artifact of how node-manta is built.
  opts.mantaUrl   = opts.mantaUrl   || process.env.MANTA_URL    || 'us-east.manta.joyent.com';
  ...
  opts.mantaKey   = opts.mantaKey   || opts.key;
