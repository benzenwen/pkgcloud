 ...
 *
 * (C) 2012-3 Nodejitsu Inc. and Joyent, Inc.
 *
 */
...
exports.upload = function (options, callback) {
  ...
  // FIXME: Manta can accept objects larger than the default 5Gb, but we need to set the content length properly. 
  var opts = options.headers['content-length'] !== undefined ?
    {
      // Regular upload
  ...
  apiStream = this.jclient.createWriteStream(this.getMantaPath({
